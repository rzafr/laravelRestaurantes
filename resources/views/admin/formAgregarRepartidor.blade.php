        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="w-full max-w-xs mx-auto">
                    <h3 class='text-lg dark:text-gray-400'>Agregar repartidor</h3>
                    
                    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method='POST' action='/repartidores/store'>
                        @csrf
